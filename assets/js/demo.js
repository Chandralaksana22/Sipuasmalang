...
$.notify({
	...
	title: 'Sipuas',
	message: 'Sistem Informasi Survei Kepuasan Pelayanan Dinas Pendidikan dan Kebudayaan Kota Malang',
},{
	type: 'info',
	placement: {
		from: "bottom",
...
var statisticsChart = new Chart(ctx, {
	...
	data: {
		...
		datasets: [ {
			...
			fill: true,
			borderWidth: 2,
			data: [9, 13, 15, 13,8, 7, 5, 17, 13, 27, 7, 9]
		}]
	},
	options : {
		responsive: true, 
