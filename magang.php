...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <!--Main Content-->
        <div>
            <center><h4 class="sipuas-mobile mt-5"><strong>Pelayanan Rekomendasi Penelitian dan Magang/ PKL/ Prakerin</strong></h4></center>
            ...
            <div class="row h-100 margin">
                ...
                <form>
                    ...
                    <div class="card-border card shadow">
                        <div class="card-body">
                            <ul>
                              <li class="textcontent">Surat permohonan dari kampus/ lembaga sekolah yang ditujukan kepada Dinas Pendidikan dan Kebudayaan Kota Malang</li>
                              <li class="textcontent">Mencantumkan nama, tanggal pelaksanaan, tempat magang, dan dari lembaga sekolah/ kampus yang telah ditandatangani oleh kepala/ ketua lembaga</li>
