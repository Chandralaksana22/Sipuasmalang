...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <!--Main Content-->
        <div>
            <center><h4 class="sipuas-mobile mt-5"><strong>Pelayanan Mutasi Siswa SD dan SMP</strong></h4></center>
            ...
            <div class="row h-100 margin">
                ...
                <form>
                    ...
                    <div class="card-border card shadow">
                        <div class="card-body">
                            <ul>
                              <li class="textcontent">Surat keterangan menerima dari sekolah tujuan</li>
                              <li class="textcontent">Surat keterangan mutasi/ pindah sekolah asal</li>
                              <li class="textcontent">Surat permohonan dari orang tua wali murid</li>
                              <li class="textcontent">Regristrasi dari Dinas Pendidikan dan Kebudayaan sekolah asal</li>
                              <li class="textcontent">Seluruh berkas rangkap 2 yang satu asli dan satu fotocopy, serta fotocopy rapot terakhir yang diindeks satu kali</li>
