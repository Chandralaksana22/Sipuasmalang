...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <!--Main Content-->
        <div>
            <center><h4 class="sipuas-mobile mt-5"><strong>Pelayanan Legalisir Ijazah</strong></h4></center>
            ...
            <div class="row h-100 margin">
                ...
                <form>
                    <div class="col-12 col-md-12 mb-4">
                      <h6 class="ml-2 mb-3 headsurvei">Persyaratan</h6>
                    <div class="card-border card shadow">
                        <div class="card-body">
                            <ul>
                              <li class="textcontent">Menunjukkan ijazah yang asli dan fotocopy sesuai kebutuhan (maksimal 10)</li>
                              <li class="textcontent">Ijazah yang dikeluarkan oleh sekolah luar kota/ kabupaten harus menunjukkan KTP sesuai domisili (sesuai peraturan RI no.29 tahun 2014)</li>
                              <li class="textcontent">Ijazah kelulusan sekolah swasta harus ke sekolah asal</li>
                              <li class="textcontent">Jika sekolah sudah tutup bisa mencari buku induk sekolah yang sudah tutup di Dinas Pendidikan dan Kebudayaan lalu difotocopy</li>
                              <li class="textcontent">Jika buku induk sekolah hilang, langkah yang dilakukan adalah mencari teman se-angkatan minimal 2 orang dengan melampirkan:
                                <ul>
                                <li class="textcontent">Fotocopy ijazah yang ada keterangan</li>
                                <li class="textcontent">Surat bermaterai 10.000</li>
                                <li class="textcontent">Fotocopy KTP</li></ul>
                              </li>
                               <li class="textcontent">Seluruh pelayanan persuratan harus melalui resepsionis di subag umum dan kepegawaian</li>
                            </ul>
                        </div>
                    </div>
                    </div>
